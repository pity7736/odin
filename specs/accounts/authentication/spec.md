...
Users must identify themselves before accessing their financial data. Authentication controls who can enter the application and ensures that each user only sees their own information.

## User Stories

### Logging in
As a user, I want to log in with my email and password so that I can access my financial accounts.
...
As a user, I expect that all my financial data (accounts, categories, incomes) is only accessible after I log in.
...
- My password is never stored or compared in plain text.

### Session
- After logging in, I stay logged in across page visits without re-entering my credentials.
...
### Protected features
- If I try to access any financial feature without being logged in, I am redirected to the login page.
- After logging in, I am taken back to the page I originally tried to visit.
- The error message for unauthorized access is consistent regardless of which feature I tried to reach.
...
- Then I am redirected to my main page
- And I can access my financial accounts
...
- When I try to access my accounts
...
- When I try to view my accounts
- Then I am redirected to the login page
- When I log in successfully
- Then I am taken to the accounts page, not the main page

## Out of Scope
- User registration (users are created manually for now)
