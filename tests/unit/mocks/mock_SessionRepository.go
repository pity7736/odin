...
import (
	...
	sessionmodel "raiseexception.dev/odin/src/accounts/domain/sessionmodel"
)
...
func (_m *MockSessionRepository) Add(ctx context.Context, session *sessionmodel.Session) error {
...
func (_c *MockSessionRepository_Add_Call) RunAndReturn(run func(context.Context, *sessionmodel.Session) error) *MockSessionRepository_Add_Call {
	_c.Call.Return(run)
	return _c
}
